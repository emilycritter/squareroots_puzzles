...
begin
  ...
  puts "Please install the google_map_service gem by running:"
  puts "`gem install google_maps_service`"
  exit
end

class GoogleMapDelivery
...
begin
  ...
  puts e.message
  raise "There was an error pulling directions from the Google Maps API"
end
